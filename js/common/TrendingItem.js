...
import {favoriteDao} from "../action/trending";
...
export default class TrendingItem extends BaseItem{
                ...
                <View style={styles.container}>
                    ...
                    <View style={styles.labelsContainer}>
                        <View style={styles.labelContainer}>
                            <Text style={styles.labelText}>Built by:</Text>
                        ...
                        <View style={styles.labelContainer}>
                            ...
                            <Text style={styles.labelText}>{item["starCount"].replace(",", "")}</Text>
                        </View>
    ...
    _onItemClick = ()=>{
        ...
        const fullName = item&&item["fullName"];
        const {isFavorite} = this.state;
    ...
    _onStarClick = ()=>{
        this.setFavorite(favoriteDao, "url");
        const {item} = this.props;
        const {storeName, url, isFavorite} = item;
        setTimeout(()=>{
            if (this.props.onFavoriteRefresh){
                this.props.onFavoriteRefresh("trending");
            }else if (this.props.onTrendingFavoriteUpdate){
                this.props.onTrendingFavoriteUpdate(storeName, url, isFavorite);
            }
        }, 500);
    };
}
